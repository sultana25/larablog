...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body { background: url({{URL::to('admin_assets/img/bg-login.jpg')}}) !important; }
		</style>
					...
					{!! Form::open(['url' => '/admin-panel','method'=>'post']) !!}
						<fieldset>
							...
							<div class="input-prepend" title="Email_address">
								...
								<input class="input-large span10" name="admin_email_address" id="admin_email_address" type="text" placeholder="type email adress"/>
							</div>
